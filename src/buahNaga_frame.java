 ...
 * @author UsEr
 */
public class buahNaga_frame extends javax.swing.JFrame {

    /**
     * Creates new form buahNaga_frame
     */
    public buahNaga_frame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buahNaga_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new buahNaga_frame().setVisible(true);
            }
        });
    }
